...
<head>
   ...
   <title>BMAcloud.de - Impressum</title>
...
<body>
   <section id="clients">
      <div class="container">
         ...
         <h2 class="section-header">Impressum
            <br>
            <small class="text-muted text-center">BMAcloud.de</small>
         </h2>
      </div>
   </section>
   <section class="bg-white">
      <div class="container">
               <h3 class="page-header">Angaben gem&auml;&szlig; &sect; 5 TMG</h3>
               <p>7systems GmbH<br>
				Schwalbenweg 22<br>
				51789 Lindlar<br>
				<a href="https://www.7systems.de">7systems.de</a></p>
               <h3 class="page-header">Kontakt</h3>
               <p>Tel. +49 2266 44 000 14<br>
				E-Mail support@bmacloud.de<br></p>
               <h3 class="page-header">Registereintrag</h3>
               <p>Eintragung im Handelsregister<br>
				Registergericht: Köln<br>
				Registernummer: B86685</p>				
      </div>
   </section>
   <section>
      <div class="container">
	               <h3 class="page-header">Haftung f&uuml;r Inhalte</h3>
			   ...
			   <h3 class="page-header">Haftung f&uuml;r Links</h3>
			   ...
			   <h3 class="page-header">Urheberrecht</h3>
...
Der Nutzung von im Rahmen der Impressumspflicht ver&ouml;ffentlichten Kontaktdaten durch Dritte zur Übersendung von nicht ausdr&uuml;cklich angeforderter Werbung und Informationsmaterialien wird hiermit ausdr&uuml;cklich widersprochen. Die Betreiber der Seiten behalten sich ausdr&uuml;cklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-Mails, vor.</p>
			   <h3 class="page-header">Datenschutzerkl&auml;rung f&uuml;r die Nutzung von Google Analytics</h3>
