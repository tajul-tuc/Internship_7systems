...
$anlage = $aid; //KWapp kompatibilit�t
...
//Pr�fplan berechnen f�r den Melder, nur wenn es noch keine manuellen Zeilen daf�r gibt
...
//Wenn der Meldertyp einen vorgegebenen Pr�fplan hat, dann diesen verwenden:
